...
func NewGenericMessageNotify(messageType Symbol, session GUID, roomId int64, partyData GenericMessageData) *GenericMessageNotify {
...
func (m *GenericMessageNotify) GetSessionID() GUID {
	return m.Session
}
