...
type Chunk struct {
	...
	Data  struct {
		...
		BroadcasterSessionEnded            *GameServerSessionEnded         `struct-case:"0x7777777777770200" json:",omitempty"`
		GameServerPlayerSessionsLocked     *GameServerSessionLocked        `struct-case:"0x7777777777770300" json:",omitempty"`
		ERGameServerPlayerSessionsUnlocked *GameServerSessionUnlocked      `struct-case:"0x7777777777770400" json:",omitempty"`
		BroadcasterPlayersAccept           *GameServerEntrants             `struct-case:"0x7777777777770500" json:",omitempty"`
		BroadcasterPlayersAccepted         *GameServerEntrantAccepted      `struct-case:"0x7777777777770600" json:",omitempty"`
		BroadcasterPlayersRejected         *GameServerEntrantsReject       `struct-case:"0x7777777777770700" json:",omitempty"`
		BroadcasterPlayerRemoved           *GameServerEntrantRemoved       `struct-case:"0x7777777777770800" json:",omitempty"`
