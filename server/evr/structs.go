...
type Chunk struct {
	...
	Data  struct {
		...
		GameServerSessionStarted           *BroadcasterSessionStartedV1     `struct-case:"0x7777777777770100" json:",omitempty"`
		BroadcasterSessionEnded            *BroadcasterSessionEndedV1       `struct-case:"0x7777777777770200" json:",omitempty"`
		GameServerPlayerSessionsLocked     *BroadcasterSessionLockedV1      `struct-case:"0x7777777777770300" json:",omitempty"`
		ERGameServerPlayerSessionsUnlocked *BroadcasterSessionUnlockedV1    `struct-case:"0x7777777777770400" json:",omitempty"`
		BroadcasterPlayersAccept           *BroadcasterSessionEntrants      `struct-case:"0x7777777777770500" json:",omitempty"`
		BroadcasterPlayersAccepted         *BroadcasterEntrantsAccepted     `struct-case:"0x7777777777770600" json:",omitempty"`
		BroadcasterPlayersRejected         *BroadcasterPlayersReject        `struct-case:"0x7777777777770700" json:",omitempty"`
		BroadcasterPlayerRemoved           *BroadcasterSessionPlayerRemoved `struct-case:"0x7777777777770800" json:",omitempty"`
